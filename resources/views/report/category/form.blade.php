        	...
        	<div class="col-md-8 col-sm-offset-2">
            	<div class="box box-success">
                	<div class="box-header with-border" style="margin-top: 50px;">
                    	<h3 class="box-title">Category wise Report Form</h3> 
                	</div>
                	<div class="box-body">
                		...
                		<div class="col-sm-12">
    						...
    						<div class="card">
    							<div class="card-header">
    								<h3 class="text-center"><i class="fa fa-chart-bar"></i> <code><b>Category wise</b></code> Report Form</h3>
    							</div>
    							<div class="card-body">
    						  		
    								
                                    {!! Form::open(['url' => 'report/category-show', 'method' => 'get', 'class' => 'form-horizontal']) !!}
                                    ...
                                    <div class="form-group {{ $errors->has('category_id') ? 'has-error' : ''}}">
                                        {!! Form::label('category_id', 'Category', ['class' => 'col-3 col-sm-3 control-label required']) !!}
                                        <div class="col-xs-9 col-sm-9">
                                           {!! Form::select('category_id', $categoryList, null, ['class' => 'form-control select2', 'placeholder' => 'Select Category', 'required' => 'required']) !!}
                                            <span class="text-danger">
