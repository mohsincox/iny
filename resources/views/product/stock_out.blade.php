    ...
    <div class="col-12 col-sm-8 offset-sm-2">
      <div class="card card-info">
        <div class="card-header">
          <h3 class="card-title"><b><kbd>{{ $product->name }}</kbd></b> Stock Out Form </h3><span class="float-right">Current Quantity: <b><kbd>{{ $product->quantity }}</kbd></b></span>
        </div>
        <div class="card-body">
          {!! Form::model($product, ['url' => "product/stock-out/$product->id", 'method' => 'put', 'class' => 'form-horizontal']) !!}
        ...
        <div class="card-footer">
          {!! Form::button('Stock Out', ['class' => 'btn btn-success pull-right', 'data-toggle' => 'modal', 'data-target' => '#stock_out']) !!}
          <a href="{{ url('/product') }}" class="btn btn-default float-right">Cancel</a>
        </div>


        <div class="modal fade" id="stock_out">
          <div class="modal-dialog">
            <div class="modal-content bg-success">
              ...
              <div class="modal-body">
                <h3>Want to Stock Out this Product?</h3>
              </div>
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-outline-light">Stock Out</button>
              </div>
            </div>
          </div>
        </div>
